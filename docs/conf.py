...
latex_documents = [
    (master_doc, 'astrohack.tex', u'Holography Antenna Commissioning Kit',
...
man_pages = [
    (master_doc, 'satrohack', u'Holography Antenna Commissioning Kit',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'astrohack', u'Holography Antenna Commissioning Kit Documentation',
     author, 'astrohack', 'One line description of project.',
     'Miscellaneous'),
]
