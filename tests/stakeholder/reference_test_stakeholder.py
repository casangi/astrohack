...
def set_data(tmp_path_factory):
  ...
  # Data files
  astrohack.astrohack.data.datasets.download('ea25_cal_small_before_fixed.split.ms', folder=str(data_dir), unpack=True)
  astrohack.astrohack.data.datasets.download('ea25_cal_small_after_fixed.split.ms', folder=str(data_dir), unpack=True)
  astrohack.astrohack.data.datasets.download('J1924-2914.ms.calibrated.split.SPW3', folder=str(data_dir), unpack=True)
  ...
  astrohack.astrohack.data.datasets.download(file='alma-test', folder=str(data_dir), unpack=True)
  astrohack.astrohack.data.datasets.download(file='vla-test', folder=str(data_dir), unpack=True)
