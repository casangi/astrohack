...
class TestExtractHolog():
    ...
    def test_extract_locit_ddi(self):
        ...
        # Usually each antenna has a ddi_0 and ddi_1 with all selected. This should just give ddi_0
    ...
    def test_extract_locit_overwrite(self):
        ...
        # an exception shouldn't be raised with overwrite set to True
        try:
    ...
    def test_extract_locit_no_overwrite(self):
        ...
        # with overwrite set to False an exception should be raised
        try:
            locit_mds = extract_locit(self.cal_table, locit_name=self.locit_name, overwrite=False)
        except:
            pass
