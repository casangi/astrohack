...
class TestHolog:
    ...
    def test_holog_perturbation_phase_fit(self):
        ...
        for ikey, key in enumerate(keys):
            assert np.isclose(pha_fit_res[key]["value"], references[ikey]), f'Phase fitting values differ from '\
                                                                            f'reference for {key}'
    ...
    def test_holog_zernike_phase_fitting(self):
        ...
        for idx, phase in ref_phase:
            assert np.isclose(phase_img[*idx], phase), f'Phase is different from reference at {idx}'
    ...
    def test_holog_zernike_coeffs(self):
        ...
        ref_zernike_coeffs = [
            3.63853142e-01+3.22356554e-02j,  4.23001476e+00+4.11000920e+01j,
            -1.75638037e+01-6.11203902e+01j,  5.44624567e+00-2.71889063e+00j,
            -2.07518837e-01-1.07029883e-02j, -5.32112029e+00+4.64863302e+00j,
            -4.44881637e+00-4.13055928e+01j,  4.26979653e+00+3.99186278e+01j,
            -8.98318910e+00-3.19533343e+01j,  1.14296814e+01+4.01677823e+01j,
            3.22839441e+00-1.57685943e+00j,  3.50888476e+00-1.55562367e+00j,
            -3.57103888e-02+1.19658639e-02j, -2.27098458e-02+2.00348932e-02j,
            9.35219135e-03-1.41071395e-02j,  1.83504535e+00+1.73453819e+01j,
            -1.95266260e+00-1.77442134e+01j,  1.85819383e+00+1.71604139e+01j,
            -1.83994376e-01-7.02351715e-01j, -1.17611308e+00-4.27534468e+00j,
            1.07348587e+00+3.73876032e+00j,  2.45203816e+00-1.12858846e+00j,
            3.60288701e-01-2.00945408e-01j,  7.99358267e-01-3.78177411e-01j,
            6.87383554e-04-3.05145445e-02j, -6.70306575e-02+2.45662583e-03j,
            2.51829138e-02+2.42719024e-03j,  1.51297987e-03-2.09583627e-02j,
            -2.18272416e-01-2.49254874e+00j,  3.18745948e-01+2.90377897e+00j,
            -3.48360089e-01-2.98705808e+00j,  2.82767637e-01+2.65015144e+00j,
            -6.45378731e-02-2.32601543e-01j, -1.78847682e-01-6.28803632e-01j,
            1.98984840e-01+6.45562396e-01j, -5.75574487e-01-2.03482119e+00j,
            -1.79071119e-01+9.75425501e-02j,  1.33041282e-01-6.08107273e-02j,
            -1.04930214e-01+1.98600004e-02j,  1.02529432e-01-4.56826111e-02j,
            -9.10502057e-02+4.00437485e-02j, -4.55895027e-02+3.88348143e-02j,
            4.98863504e-03-2.49634561e-02j,  1.81918402e-02+1.18122844e-02j,
            -1.60219775e-02-2.28458691e-02j,  1.47953573e-02+1.31553475e-01j,
            7.77135087e-03+3.36702956e-02j,  2.47718592e-02-3.50457522e-02j,
            -2.67166187e-02+1.18180934e-02j, -1.46191264e-02-7.72276561e-02j,
            -3.00941394e-02-9.87108070e-02j,  8.96918830e-03-2.84022568e-02j,
            -1.65357311e-03-4.38318775e-02j,  1.50658709e-02-6.14483136e-02j,
            4.87811290e-02+1.75694507e-01j, -4.81118972e-03+3.73321157e-03j,
            4.60629264e-02-3.62603959e-02j, -1.21179544e-03+2.53104896e-02j,
            1.75069126e-02+1.04703864e-02j,  8.61753013e-03+2.54347275e-03j,
            5.40815261e-02-2.62438937e-02j,  4.45687952e-02-4.29741834e-02j,
            4.25176984e-02+4.59819354e-02j, -1.46957058e-02-3.46945617e-02j,
            3.38637874e-02-1.08213929e-02j, -2.06739538e-02+1.35215571e-03j,
        ]
        ...
        assert np.allclose(ref_zernike_coeffs, zer_coeffs), 'Fitted Zernike coefficients do not match references'
